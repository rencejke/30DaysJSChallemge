...
//12 
let sentrence = 'You cannot end a sentence with because because because is a conjunction'
console.log(sentrence.substr(31, 23)) //because first occurence is in index 31, then counnt the length to be sliced
