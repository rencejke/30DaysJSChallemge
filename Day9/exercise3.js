...
const sortByName = countries_data.sort()
console.log(sortByName) 

const sortByCapital = countries_data.sort((a, b) =>
{
    if(a.capital < b.capital) return - 1 //a comes first
    if (a.capital > b.capital) return 1 //b comes first
    
    return  0 //otherwise keep their order
})
...
{
    if(a.population < b.population) return - 1 //a comes first
    if (a.population > b.population) return 1 //b comes first
...
// Get all languages and count how many times each language appears
const getLanguagesCounts = (arr) =>
arr.reduce((acc, curr) =>
{
    // Collect all languages from each country
...
// Copy the object returned by getLanguagesCounts()
//
// Example:
// {
//     Pashto: 1,
...
//     ...
// }
const topSpokenLanguages = Object.assign({}, getLanguagesCounts(countries_data))

// Convert the object into an array of [key, value] pairs
//
// Example:
// [['Pashto', 1], ['Uzbek', 2], ...]
const countries = Object.entries(topSpokenLanguages)

// 1. Transform each [language, count] pair into an object
// 2. Sort by count in descending order (highest → lowest)
// 3. Get only the first `limit` languages
